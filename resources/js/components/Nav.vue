<template>
    <div class="bg-white h-12 px-4 flex items-center border-b-2 border-gray-400 shadow-sm">
        <div class="w-1/3">
            <div class="flex">
                <router-link to='/'>
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="rounded-full w-56 bg-gray-200 pl-8 h-8 focus:outline-none focus:shadow-outline text-sm" placeholder="Search Facebook">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/" class="px-6 flex items-center h-full border-b-2 border-blue-600">
            ...
            <router-link :to="'/users/' + authUser.data.user_id" class="px-6 flex items-center h-full">
                <img :src="'/img/profile.jpg'" alt="Profile Image" class="w-10 h-10 object-cover rounded-full">
            </router-link>
            <router-link to="/" class="px-6 flex items-center h-full">
